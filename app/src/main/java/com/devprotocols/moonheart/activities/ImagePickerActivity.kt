...
class ImagePickerActivity : AppCompatActivity() {
    ...
    private var aspectRatioX = 16F
    private var aspectRatioY = 9F
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        aspectRatioX = intent.getIntExtra(INTENT_ASPECT_RATIO_X, aspectRatioX.toInt()).toFloat()
        aspectRatioY = intent.getIntExtra(INTENT_ASPECT_RATIO_Y, aspectRatioY.toInt()).toFloat()
    ...
    private fun cropImage(sourceUri: Uri?) {
        ...
        if (lockAspectRatio) options.withAspectRatio(aspectRatioX, aspectRatioY)
    ...
    companion object {
        ...
        fun showImagePickerOptions(context: Context, listener: PickerOptionListener) {
            ...
            // add a list
            val animals = arrayOf("From Camera", "From Gallery")
            builder.setItems(
                animals
